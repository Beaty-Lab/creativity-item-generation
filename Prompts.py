...
class _ConsequencesPromptTemplate:  # TODO: add prompts
    ...
    consequences_item_gen_prompts = [
        [  # 0, few-shot
            (
                "system",
                "You are an author tasked with producing scenarios for a short story. You must write scenarios that would fundamentally alter how human life or the world would work. Your scenarios should be grounded in reality as much as possible. Inclusion of sci-fi or fantasy elements is fine, but such elements should be framed in a  'slice of life' context and be relatable to the typical human. Follow the format of the example scenarios provided to you, but don't copy the content. Begin each scenario with 'What would be the result if'.",
            ),
            (
                "human",
                ...
                4. What would be the result if none of us needed food in order to live?
                5. What would happen if gravity ceased to exist? 
