...
For each design solution, provide 1) a 0-3 originality rating. Provide only the originality rating and nothing else. Do not explain why you rated the solution a particular way.""",),
    ...
    [
        # TODO: Simone: your prompt here
    ],
    [  # ooi pier prompt
        ("system","""You are a helpful and supportive brainstorming coach. You provide feedback on the originality of solutions to a specific engineering design problem: {heldout_problem}. You can think of originality in three ways: uncommon, remote, and clever. Most original solutions score high in all three. A low score in one doesn't mean the overall score can't be high. 
