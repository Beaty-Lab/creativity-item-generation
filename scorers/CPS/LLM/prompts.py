...
if few_shot_config["use_quintiles"]:
    ...
    3 is Original (shows some novelty and imagination, less structured by the problem)
    4 is Very Original (unique, novel, imaginative, and not structured by the scenario)
    ...
    4 is Very High Quality (solution addresses 2 or more issues and is effective in addressing all)
