...
# o1 doesn't support the system prompt yet
o1_prompts = [
        [
        # difficulty
            ("human", """You are a subject matter expert evaluating items for a test of problem solving ability. Given a scenario written for you by a team member, you will evaluate the difficulty of the scenario. Here's the rubric you will use while evaluating:
    ...
    [  # complexity
            ("human", """You are a subject matter expert evaluating items for a test of problem solving ability. Given a scenario written for you by a team member, you will evaluate the complexity of the scenario. Here's the rubric you will use while evaluating:
